...
type BalanceSheet struct {
	...
	F117N float64 `excel:"交易性金融资产"`                            //交易性金融资产
	F118N float64 `excel:"应收票据及应收账款"`                          //应收票据及应收账款
	F119N float64 `excel:"合同资产"`                               //合同资产
	...
	F116N float64 `excel:"债权投资"`                               //债权投资
	F110N float64 `excel:"其他债权投资"`                             //其他债权投资
	F111N float64 `excel:"其他权益工具投资"`                           //其他权益工具投资
	F112N float64 `excel:"其他非流动金融资产"`                          //其他非流动金融资产
	...
	F113N float64 `excel:"交易性金融负债"`                            //交易性金融负债
	F114N float64 `excel:"应付票据及应付账款"`                          //应付票据及应付账款
	F115N float64 `excel:"合同负债"`                               //合同负债
