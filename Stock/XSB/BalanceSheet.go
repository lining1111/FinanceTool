...
type BalanceSheet struct {
	...
	F106N float64 `excel:"应收票据及应收账款"`                          //应收票据及应收账款	decimal(18,2)	元	20210826新增
	F107N float64 `excel:"应付票据及应付账款"`                          //应付票据及应付账款	decimal(18,2)	元	20210826新增
	F108N float64 `excel:"资产-其他资产"`                            //资产-其他资产	decimal(18,2)	元	20210826新增
	F109N float64 `excel:"交易性金融资产"`                            //交易性金融资产_	decimal(18,2)	元	20210826新增
	F110N float64 `excel:"应收款项融资"`                             //应收款项融资	decimal(18,2)	元	20210826新增
	F111N float64 `excel:"合同资产"`                               //合同资产	decimal(18,2)	元	20210826新增
	F112N float64 `excel:"债权投资"`                               //债权投资	decimal(18,2)	元	20210826新增
	F113N float64 `excel:"其他债权投资增"`                            //其他债权投资	decimal(18,2)	元	20210826新增
	F114N float64 `excel:"其他权益工具投资"`                           //其他权益工具投资	decimal(18,2)	元	20210826新增
	F115N float64 `excel:"其他非流动金融资产增"`                         //其他非流动金融资产	decimal(18,2)	元	20210826新增
	F116N float64 `excel:"交易性金融负债"`                            //交易性金融负债_	decimal(18,2)	元	20210826新增
	F117N float64 `excel:"合同负债"`                               //合同负债	decimal(18,2)	元	20210826新增
	F118N float64 `excel:"非流动负债-保险合同准备金"`                      //非流动负债-保险合同准备金	decimal(18,2)	元	20210826新增
	F119N float64 `excel:"租赁负债"`                               //租赁负债	decimal(18,2)	元	20210826新增
	F120N float64 `excel:"资产-其他负债"`                            //资产-其他负债	decimal(18,2)	元	20210826新增
	F121N float64 `excel:"资产-发放贷款及垫款"`                         //资产-发放贷款及垫款	decimal(18,2)	元	20210826新增
	F122N float64 `excel:"期货会员资格投资"`                           //期货会员资格投资	decimal(18,2)	元	20210826新增
	F123N float64 `excel:"期货风险准备金"`                            //期货风险准备金	decimal(18,2)	元	20210826新增
	F124N float64 `excel:"应收货币保证金"`                            //应收货币保证金	decimal(18,2)	元	20210826新增
	F125N float64 `excel:"应付货币保证金"`                            //应付货币保证金	decimal(18,2)	元	20210826新增
	F126N float64 `excel:"使用权资产"`                              //使用权资产	decimal(18,2)	元	20210826新增
	F127N float64 `excel:"融出资金"`                               //融出资金	decimal(18,2)	元	20210826新增
	F128N float64 `excel:"非流动资产-以公允价值计量且其变动计入当期损益的金融资产"`       //非流动资产-以公允价值计量且其变动计入当期损益的金融资产	decimal(18,2)	元	20210826新增
	F129N float64 `excel:"非流动负债-以公允价值计量且其变动计入当期损益的金融负债"`       //非流动负债-以公允价值计量且其变动计入当期损益的金融负债	decimal(18,2)	元	20210826新增
}
