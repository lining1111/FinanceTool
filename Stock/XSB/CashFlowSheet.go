...
type CashFlowSheet struct {
	...
	F042N float64 //附注：	decimal		单位：元
	F043N float64 //1、将净利润调节为经营活动现金流量：	decimal		单位：元
	...
	F060N float64 //经营活动产生的现金流量净额（附注）	decimal		单位：元
	F061N float64 //2、不涉及现金收支的重大投资和筹资活动：	decimal		单位：元
	F062N float64 //债务转为资本	decimal		单位：元
	F063N float64 //一年内到期的可转换公司债券	decimal		单位：元
	F064N float64 //融资租入固定资产	decimal		单位：元
	F065N float64 //3、现金及现金等价物净变动情况：	decimal		单位：元
	...
	F092N float64 //为交易目的而持有金融资产净增加额	decimal(18,2)	元	20210826新增
	F093N float64 //拆出资金净增加额	decimal(18,2)	元	20210826新增
	F094N float64 //信用减值损失	decimal(18,2)	元	20210826新增
	F095N float64 //少数股东损益	decimal(18,2)	元	20210826新增
	F096N float64 //待摊费用的减少	decimal(18,2)	元	20210826新增
	F097N float64 //预提费用的增加	decimal(18,2)	元	20210826新增
	F098N float64 //递延收益摊销	decimal(18,2)	元	20210826新增
	F099N float64 //预计负债的增加	decimal(18,2)	元	20210826新增
}
